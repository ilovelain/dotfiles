...
pacstrap /mnt base base-devel linux linux-firmware linux-headers openssh grub efibootmgr networkmanager wayland zsh git neovim swaybg nodejs firefox htop pulseaudio alsa-lib alsa-utils pulsemixer sway seatd waybar grim wl-clipboard ranger kitty ripgrep lazygit ttc-iosevka ttf-iosevka-nerd

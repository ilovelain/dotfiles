...
pacstrap /mnt base base-devel linux linux-firmware linux-headers openssh grub efibootmgr networkmanager firefox wayland zsh git neovim swaybg pipewire sway seatd waybar grim wl-clipboard ranger kitty ripgrep lazygit ttc-iosevka ttf-iosevka-nerd
